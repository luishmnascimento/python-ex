...
#print(cores["azul"],'Luís Henrique Maia Nascimento')

nome = str(input('Qual seu nome: ')).upper().split()

print(cores['azul em negrito'], nome[0], cores['vermelho em negrito'], nome[1])
